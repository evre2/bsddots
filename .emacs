...
(setq initial-buffer-choice "/home/leek/Documents/Code") ;; Set the path you want to be opened on start up
...
(set-background-color "White")
 (set-face-attribute 'mode-line nil :box nil :foreground "Black" :background "White")
  (set-face-attribute 'mode-line-inactive nil :box nil :foreground "Gray" :background "White")
(set-face-attribute 'default nil :font "Inconsolata" :height 140) ;; Use whatever font you want
...
(defun daylight()
  ...
  (set-background-color "White")
  (set-face-attribute 'mode-line nil :box nil :foreground "Black" :background "White")
  (set-face-attribute 'mode-line-inactive nil :box nil :foreground "White" :background "White"))
(defun nightlight()
  (interactive)
  (load-theme 'tango-dark)
  (set-face-attribute 'mode-line nil :box nil :foreground "White" :background "Black")
  (set-face-attribute 'mode-line-inactive nil :box nil :foreground "DarkGray" :background "Black")
